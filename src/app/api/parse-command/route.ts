...
export async function POST(request: Request) {
  ...
  const system = [
    ...
    "4. For a new application, also: create_contact for each named contact (name + role/linkedin if given), and create_task with type 'linkedin_outreach' due 48 hours from now to nudge the outreach.",
